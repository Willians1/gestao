    ...
    >
      <Box sx={{ maxWidth: { xs: '100%', lg: 1200 }, mx: 'auto', mt: { xs: 1, md: 3 } }}>
            ...
            InputProps={{
              ...
              endAdornment: searchTerm && (
                <InputAdornment position="end">
                  <Button size="small" onClick={clearSearch} sx={{ minWidth: 'auto', p: 0.5 }}>
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} sx={{ mb: 2 }}>
          <Chip
            label={searchTerm ? `${total} de ${rows.length} clientes` : `${total} clientes`}
              ...
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={7} align="center">
                    <Typography
                      variant="body2"
                      sx={{ fontSize: { xs: '0.75rem', sm: '0.875rem' }, py: 2 }}
                    >
                      {searchTerm
        ...
        <Dialog
          open={!!selectedCliente && !openEditModal}
          ...
          <DialogContent>
            {selectedCliente && (
              <Box sx={{ pt: 1 }}>
                ...
                <Typography sx={{ mb: 1 }}>
                  <strong>CNPJ:</strong> {selectedCliente.cnpj || 'Não informado'}
                </Typography>
                <Typography sx={{ mb: 1 }}>
                  <strong>Email:</strong> {selectedCliente.email || 'Não informado'}
                </Typography>
                <Typography sx={{ mb: 1 }}>
                  <strong>Contato:</strong> {selectedCliente.contato || 'Não informado'}
                </Typography>
                <Typography sx={{ mb: 1 }}>
                  <strong>Endereço:</strong> {selectedCliente.endereco || 'Não informado'}
                </Typography>
              </Box>
            )}
          </DialogContent>
          <DialogActions>
            ...
            {canUpdate && (
              <Button
                variant="outlined"
                color="primary"
                onClick={() => openEditDialog(selectedCliente)}
                disabled={saving}
              >
                Editar
              </Button>
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              ...
              disabled={saving || !editForm.nome || !editForm.cnpj}
            >
