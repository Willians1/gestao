    ...
    >
      <Box sx={{ maxWidth: 1200, mx: 'auto', mt: { xs: 1, md: 3 } }}>
        ...
        >
          ...
          >
            <Typography variant={isMobile ? 'body2' : 'subtitle1'} sx={{ mr: 1 }}>
              Total de resultados:
            </Typography>
            <Chip
              label={total}
        ...
        >
          <Chip label="CNPJ" onDelete={() => {}} size={isMobile ? 'small' : 'medium'} />
          <Chip label="Telefone" onDelete={() => {}} size={isMobile ? 'small' : 'medium'} />
        </Stack>
        {/* Tabela Responsiva */}
        <TableContainer
          component={Paper}
